...
require "fileutils"
require "tmpdir"
require "generators/recording_studio_oauth/install/install_generator"

class InstallGeneratorTest < Minitest::Test
  INSTALL_TEMPLATE_PATH = File.expand_path(
    "../lib/generators/recording_studio_oauth/install/templates/INSTALL.md",
    __dir__
  )
  ...
  def build_generator(destination_root, options = {})
    RecordingStudioOauth::Generators::InstallGenerator.new(
      [],
      options,
