...
module RecordingStudioOauth
  module Generators
    # Generator to install RecordingStudioOauth migrations into the host application.
    #
    # Usage:
    #   rails generate recording_studio_oauth:migrations
    #
    # Options:
    ...
    class MigrationsGenerator < Rails::Generators::Base
      ...
      desc "Copy RecordingStudioOauth migrations to your application"
      ...
      def copy_migrations
        ...
        unless File.directory?(migrations_dir)
          say "No migrations found in RecordingStudioOauth engine.", :yellow
          return
        end
        ...
        migration_files.each do |source_path|
          ...
          # Extract migration name without timestamp (e.g., "create_recording_studio_oauth_pages.rb")
