...
- Connect list has no PageNav. The list sits in a Card with default padding. Trailing status is a Flatpack Button (Connect/Reconnect primary, Connected secondary). Permission title is `{picked parent} permissions`. Primary action is Connect.
