...
module RecordingStudioOauth
  class OauthAuthorizationsController < ApplicationController
    ...
    def create
      ...
      result = Services::CreateOauthAuthorization.call(
    ...
    def load_oauth_request
      ...
      @api_key = params[:api_key].to_s.presence || "public"
      ...
      unless RecordingStudioOauth.protected_resources(api_key: @api_key).permit?(params[:resource], base_url: request.base_url)
        render_oauth_error("invalid_target", "resource is not a registered protected resource")
        return
      end
    ...
    def authorize_form_url
      if @api_key == "public"
        ...
        named_api_oauth_authorize_path(api_key: @api_key)
      end
    end
    ...
    def connect_choice_url(access_recording = nil)
      ...
      if @api_key == "public"
        ...
        named_api_oauth_authorize_path(extras.merge(api_key: @api_key))
      end
    end
